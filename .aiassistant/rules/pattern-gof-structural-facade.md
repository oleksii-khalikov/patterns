...
instructions: Apply when providing a simplified interface to a complex subsystem. Use to reduce coupling between clients and complex library/framework internals.
---
