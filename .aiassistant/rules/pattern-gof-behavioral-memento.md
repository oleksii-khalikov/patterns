...
instructions: Apply when capturing and restoring an object's internal state without violating encapsulation. Use for implementing undo/redo or snapshot functionality.
---
