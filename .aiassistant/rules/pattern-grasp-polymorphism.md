...
instructions: Apply when handling type-based variations through polymorphic method calls instead of conditionals. Use to replace switch/if-else statements based on type.
---

# Polymorphism (GRASP Pattern)
