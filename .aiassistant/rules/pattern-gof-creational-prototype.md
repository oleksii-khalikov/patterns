...
instructions: Apply when creating objects by cloning existing instances rather than using constructors. Use when object creation is expensive or classes are specified at runtime.
---
