...
|---|---|---|
| Human Evaluation  | Captures subtle behavior  | Dificult to scale, expensive, and time-consuming, as it considers subjective human factors.  |
| LLM-as-a-Judge  | Consistent, eficient, and scalable.  | Intermediate steps may be overlooked. Limited by LLM capabilities.  |
| Automated Metrics  | Scalable, eficient, and objective  | Potential limitation in capturing complete capabilities.  |
